...
if ($ADMIN->fulltree) {
    ...
    $page->add(new admin_setting_heading(
        ...
        get_string('dashboardsetting', 'theme_remui'),
        format_text(get_string('dashboardsettingdesc', 'theme_remui'), FORMAT_MARKDOWN)
    ));

    // Course Progress Block Setting
    $name = 'theme_remui/enablecourseprogressblock';
    $title = get_string('courseprogressblock', 'theme_remui');
    $description = get_string('courseprogressblockdesc', 'theme_remui');
    $default = true;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    ...
    $title = get_string('enrolledusersblock', 'theme_remui');
    $description = get_string('enrolledusersblockdesc', 'theme_remui');
    $default = true;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    ...
    $title = get_string('quizattemptsblock', 'theme_remui');
    $description = get_string('quizattemptsblockdesc', 'theme_remui');
    $default = true;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    ...
    $title = get_string('courseanlyticsblock', 'theme_remui');
    $description = get_string('courseanlyticsblockdesc', 'theme_remui');
    $default = true;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    ...
    $title = get_string('latestmembersblock', 'theme_remui');
    $description = get_string('latestmembersblockdesc', 'theme_remui');
    $default = true;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    ...
    $title = get_string('addnotesblock', 'theme_remui');
    $description = get_string('addnotesblockdesc', 'theme_remui');
    $default = true;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    ...
    $title = get_string('recentfeedbackblock', 'theme_remui');
    $description = get_string('recentfeedbackblockdesc', 'theme_remui');
    $default = true;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    ...
    $title = get_string('recentforumsblock', 'theme_remui');
    $description = get_string('recentforumsblockdesc', 'theme_remui');
    $default = true;
    $setting = new admin_setting_configcheckbox($name, $title, $description, $default, true, false);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
